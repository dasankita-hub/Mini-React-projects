...
const BgColorChanger = () => {
  ...
  return (
    <div className="w-full h-screen" style={{ backgroundColor: color }}>
      <div className="fixed flex flex-wrap justify-center bottom-11 inset-x-0 px-2 ">
        <div className="flex flex-wrap justify-center gap-3 shadow-lg px-2 py-2 bg-slate-500 rounded-3xl">
          <button
            ...
            className="outline-none px-3 py3 rounded-full  shadow-lg text-white"
          ...
          <button
            ...
            className="outline-none px-3 py3 rounded-full shadow-lg text-black"
      ...
      <h1
        className="text-3xl font-bold flex flex-wrap justify-center bottom-5"
